<x-app-layout title="Edit User">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-3xl font-extrabold text-white">Edit User</h1>
    </div>
    ...
    <div class="card max-w-xl">
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-5">
            ...
            <div>
                <label class="form-label" for="password">New Password <span class="text-zinc-500">(leave blank to keep)</span></label>
